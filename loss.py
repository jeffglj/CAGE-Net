...
class MatchLoss(object):
  ...
  def run(self, global_step, data, logits, ys, e_hat, y_hat):#return ws0 + ws1, [y, y, y1, y1, y2], [e_hat], y_hat
    ...
    for i in range(len(logits)):
        ...
        #classif_loss = classif_loss.type(torch.LongTensor)
